...
.stApp, [data-testid="stAppViewContainer"], [data-testid="stHeader"] { background: #f7f9fc; color: #1f2937; }

.hero {
    background: #ffffff; border: 1px solid #d9e2ec; border-radius: 14px;
    padding: 30px 40px; margin-bottom: 26px; position: relative; overflow: hidden;
    box-shadow: 0 4px 18px rgba(31,41,55,0.08);
}
.hero::before { content:''; position:absolute; top:0; left:0; right:0; height:3px; background:#2563eb; }
.hero::after { content:''; position:absolute; right:-60px; top:-60px; width:200px; height:200px; border-radius:50%; background:rgba(37,99,235,0.04); }
.hero-title { font-family:'Share Tech Mono',monospace; font-size:1.85rem; color:#1d4ed8; margin:0; letter-spacing:.04em; }
.hero-sub { font-size:.82rem; color:#64748b; margin-top:7px; letter-spacing:.1em; text-transform:uppercase; font-weight:700; }

.sec {
    font-family:'Share Tech Mono',monospace; font-size:.74rem; color:#1d4ed8;
    letter-spacing:.18em; text-transform:uppercase; border-bottom:1px solid #d9e2ec;
    padding-bottom:5px; margin:22px 0 14px;
}
.def-card {
    background:#ffffff; border:1px solid #d9e2ec; border-left:4px solid #2563eb;
    border-radius:10px; padding:15px 18px; margin-bottom:12px;
    box-shadow:0 2px 8px rgba(31,41,55,0.05); transition:transform .2s;
}
.def-card:hover { transform:translateX(4px); }
.def-title { font-weight:800; color:#1d4ed8; font-size:.9rem; margin-bottom:5px; }
.def-body { font-size:.83rem; color:#475569; line-height:1.68; }

.info-box {
    background:#ffffff; border:1px solid #d9e2ec; border-radius:10px;
    padding:16px 20px; font-size:.86rem; color:#475569; line-height:1.7;
}
.info-box strong { color:#1d4ed8; }
.amber-box {
    background:#f8fafc; border:1px solid #cbd5e1; border-radius:10px;
    padding:14px 18px; font-size:.84rem; color:#475569; line-height:1.65; margin:10px 0;
}
.amber-box strong { color:#1d4ed8; }

.mc {
    background:#ffffff; border:1px solid #d9e2ec; border-radius:10px;
    padding:14px 10px; text-align:center; box-shadow:0 2px 8px rgba(31,41,55,0.05);
}
.mc .ml { font-size:.65rem; color:#64748b; text-transform:uppercase; letter-spacing:.09em; font-weight:700; }
.mc .mv { font-family:'Share Tech Mono',monospace; font-size:1.35rem; color:#1d4ed8; margin-top:4px; }
.mc .mu { font-size:.65rem; color:#94a3b8; }

.status-reg { background:#f0fdf4; border:2px solid #22c55e; border-radius:8px; padding:12px 18px; color:#15803d; font-family:'Share Tech Mono',monospace; font-size:.9rem; }
.status-unreg { background:#fff7ed; border:2px solid #f59e0b; border-radius:8px; padding:12px 18px; color:#b45309; font-family:'Share Tech Mono',monospace; font-size:.9rem; }

.score-pass { background:#f0fdf4; border:2px solid #22c55e; border-radius:12px; padding:20px; color:#15803d; }
.score-mid { background:#eff6ff; border:2px solid #60a5fa; border-radius:12px; padding:20px; color:#1d4ed8; }
.score-fail { background:#fff1f2; border:2px solid #fb7185; border-radius:12px; padding:20px; color:#be123c; }

.pd { background:#ffffff; border:2px solid #cbd5e1; border-radius:8px; padding:9px 0; text-align:center; font-family:'Share Tech Mono',monospace; font-size:1.2rem; color:#1d4ed8; font-weight:700; }
.pl { font-size:.68rem; color:#64748b; text-transform:uppercase; letter-spacing:.09em; text-align:center; margin-bottom:3px; font-weight:700; }

.cmp-table { width:100%; border-collapse:collapse; font-size:.84rem; border-radius:10px; overflow:hidden; }
.cmp-table th { background:#eaf1fb; color:#1d4ed8; padding:10px 14px; text-align:left; font-weight:800; }
.cmp-table td { padding:9px 14px; border-bottom:1px solid #e2e8f0; color:#475569; }
.cmp-table tr:nth-child(even) td { background:#f8fafc; }
.cmp-table td:first-child { font-weight:700; color:#1d4ed8; }

[data-testid="stSidebar"] { background:#ffffff; border-right:1px solid #d9e2ec; }
[data-testid="stSidebar"] h2, [data-testid="stSidebar"] h3 { color:#1d4ed8; }
...
.stTabs [data-baseweb="tab-list"] {
    background:#ffffff; border-bottom:2px solid #d9e2ec;
...
.stTabs [aria-selected="true"] {
    ...
    border-bottom:3px solid #2563eb !important; border-radius:8px 8px 0 0;
}

.stButton > button {
    background:#ffffff; color:#1d4ed8; border:1px solid #93c5fd; border-radius:8px;
...
.stButton > button:hover { background:#eff6ff; border-color:#2563eb; transform:translateY(-1px); }

.stNumberInput label, .stSelectbox label, .stRadio label {
    color:#334155 !important; font-weight:600 !important; font-size:.85rem !important;
}
div[data-baseweb="radio"] > div {
    background:#ffffff; border:1px solid #d9e2ec; border-radius:8px;
    padding:8px 12px; margin:4px 0; transition:all .15s;
}
div[data-baseweb="radio"] > div:hover { background:#f8fafc; border-color:#93c5fd; }
